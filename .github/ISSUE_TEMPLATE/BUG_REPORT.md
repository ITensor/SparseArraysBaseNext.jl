---
name: SparseArraysBaseNext.jl bug report
about: Create a bug report to help us improve SparseArraysBaseNext.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("SparseArraysBaseNext")`:
```julia
julia> using Pkg; Pkg.status("SparseArraysBaseNext")
[YOUR OUTPUT HERE]
```
